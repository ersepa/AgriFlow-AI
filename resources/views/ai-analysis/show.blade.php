<x-app-layout>
    <div class="max-w-6xl mx-auto py-10 px-4 sm:px-6">
        <a href="{{ route('ai-analysis.history') }}" class="inline-flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition-all hover:-translate-x-1 mb-8 font-bold text-xs uppercase tracking-widest">
            ← Back to history
        </a>
