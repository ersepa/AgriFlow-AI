            ...
            <div class="agri-dark-card p-6 sm:p-8 mb-10 text-white relative overflow-hidden">
                ...
                <div class="mb-8 bg-slate-800/60 border border-slate-700/80 rounded-2xl p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
                        ...
                        <div>
                            <p class="text-xs text-slate-400 font-bold uppercase tracking-wider">Recorded Time Remaining</p>
                            <p class="font-extrabold text-white text-base mt-0.5">{{ number_format($shipmentData['remaining_days'], 2) }} Days</p>
                        </div>
                ...
                @endif
                @include('ai-analysis.partials.freshness-result')
                {{-- Primary KPI Cards --}}
                ...
                @include('ai-analysis.partials.risk-engine-result')

                {{-- Operational Risk Explainability Drivers Section --}}
                ...
                <div class="mb-8 bg-slate-800/60 border border-slate-700/80 rounded-3xl p-6 sm:p-8">
                    <div class="flex items-center justify-between mb-6 pb-4 border-b border-slate-700">
                        <div>
                            <p class="text-xs uppercase tracking-[0.25em] text-indigo-400 font-black">Operational Risk Explainability</p>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <div class="text-right">
                                    <p class="text-white font-black text-base">{{ number_format($driver['impact'], 1) }} pts</p>
                    ...
                    <div class="mt-8 border-t border-slate-700 pt-6">
                        <div class="flex justify-between mb-2">
                            <span class="text-slate-400 font-bold text-xs uppercase tracking-wider">Weighted Risk Contribution Sum</span>
