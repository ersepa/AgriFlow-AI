    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 animate-card">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div>
                ...
                <p class="text-slate-500 mt-1 font-medium text-sm">Historical decision-support snapshots. Older records may use legacy score semantics; use the current shipment assessment for current-state decisions.</p>
            </div>
        ...
        <div class="agri-card p-6 sm:p-8">
            ...
            <div class="mb-5 rounded-2xl border border-amber-200 bg-amber-50/70 px-4 py-3 text-xs leading-relaxed text-amber-900">
                <strong>* Compatibility note:</strong> historical rows retain legacy database column names and may contain scores generated by earlier model versions. The stored risk value is an Operational Risk Index, not a spoilage probability. Open a shipment for the current assessment.
            </div>
                ...
                <table class="w-full text-left border-separate border-spacing-y-3">
                    <thead>
                        <tr class="text-slate-500 font-extrabold text-[11px] uppercase tracking-wider">
                            ...
                            <th class="px-6 py-3">Stored Decision Score*</th>
                            <th class="px-6 py-3">Operational Risk Index*</th>
                            ...
                            <tr class="agri-table-row {{ $theme['bg'] }} border {{ $theme['border'] }} rounded-2xl overflow-hidden">
                                ...
                                <td class="px-6 py-5 border-t border-b {{ $theme['border'] }} bg-white">
                                    <span class="inline-flex items-center px-3.5 py-1.5 text-[10px] font-black uppercase tracking-wider rounded-xl border shadow-sm
                                        ...
                                        {{ $a->risk_level === 'Medium' ? 'Moderate' : $a->risk_level }}
                                    </span>
                                </td>
